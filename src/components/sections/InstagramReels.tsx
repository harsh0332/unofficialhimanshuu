...
export default function InstagramReels() {
  ...
  const featuredReels: Reel[] = [
    {
      id: 1,
      title: "The Art of Cinematic Lighting in Indore",
    ...
    {
      id: 2,
      title: "Behind The Scenes: Capturing Raw Emotions",
    ...
    {
      id: 3,
      title: "Central India's Digital Creator Boom",
      ...
      videoUrl: "/reel3.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to view localized creator community metrics",
    },
  ];
