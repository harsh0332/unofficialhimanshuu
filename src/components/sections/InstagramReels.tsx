  ...
  const featuredReels: Reel[] = [
    {
      ...
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-lens-of-a-camera-adjusting-42858-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to preview high-contrast studio setups live",
    },
    {
      id: 2,
      ...
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-filmmaker-setting-up-a-camera-42862-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to watch raw multi-cam set captures live",
    },
    {
      id: 3,
      ...
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-taking-photos-with-a-smartphone-34316-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to view localized community metrics live",
    },
    {
      id: 4,
      ...
      likes: "73K",
      comments: "540",
      thumbnail: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&q=80&w=600",
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-photographer-taking-pictures-of-a-model-42855-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to preview unscripted connection hooks live",
    },
    {
      id: 5,
      ...
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-hands-of-a-filmmaker-adjusting-a-camera-42857-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to preview dynamic ember grading setups live",
    },
    {
      id: 6,
      ...
      videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-videographer-holding-a-gimbal-42861-large.mp4",
      instagramUrl: "https://www.instagram.com/unofficialhimanshu/",
      captionHint: "Hover to watch raw visual framing layouts live",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <p className="max-w-xl font-inter text-sm text-brand-bone-secondary leading-relaxed text-left">
            Explore Himanshu Soni's viral vertical asset engine. Standard video metrics don't capture the whole story—these are high-converting vertical cuts optimized to spark cultural conversation and maximize brand recall.
          </p>
        </div>
              ...
              >
                ...
                <div className="absolute top-4 left-4 z-20 bg-brand-ink/90 border border-brand-border-accent px-2 py-1 flex items-center gap-1.5 pointer-events-none">
                  ...
                  <span className="font-inter text-[8px] text-brand-bone font-bold uppercase tracking-widest leading-none">
                    {hoveredReelId === reel.id && !shouldReduceMotion ? "PLAYING LOOP" : "INSTA HOVER LIVE"}
                  </span>
                </div>
